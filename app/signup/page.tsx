            ...
            <div className="max-w-2xl w-full">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 animate-slideUp">
                    ...
                    <form className="space-y-5">
                        ...
                        <button
                            type="submit"
                            className="w-full py-3 px-4 bg-orange-600 text-white font-medium rounded-lg hover:bg-orange-700 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
                        >
                            Create Account
                        </button>
                    </form>
